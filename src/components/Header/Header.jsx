    ...
    return ( 
        <header className='w-full bg-blue-900 text-white text-md h-20 shadow-md flex flex-row justify-between items-center px-10'>
            ...
            <nav className='flex flex-row items-center justify-end h-full'>
                <Link to='/'>Home</Link>
                <a className='mx-4 hover:underline' href="#cart" onClick={ e => e.preventDefault()}>Shopping Cart <FontAwesomeIcon icon={ faShoppingCart} /> <span className='text-orange-400 font-bold text-lg'>({ cartCount })</span></a>
